...
const instructions inst[] = {
    ...
    {.func_name = "VAES_ISHIFT", .func3 = 0b011, .op = 0b100, .func11 = 0b00000000001},
    {.func_name = "VAES_MIX",    .func3 = 0b100, .op = 0b100, .func11 = 0b00000000001},
    {.func_name = "VAES_IMIX",   .func3 = 0b101, .op = 0b100, .func11 = 0b00000000001},
    {.func_name = "VAES_WXOR",   .func3 = 0b110, .op = 0b100, .func11 = 0b00000000001},
};
typedef struct {
  char* name;
  unsigned int val;
